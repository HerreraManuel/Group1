...
public class GitParser
{
    ...
    {
        File out = new File("/homefsak"); //TODO: <--- Modify this constructor with a string that includes the filepath and folder name that you wish to clone the repository to.
