...
public class GitParser
{
    ...
    {
        File out = new File("/home/filipinoy/Desktop/TestRepo2"); //TODO: <--- Modify this constructor with a string that includes the filepath and folder name that you wish to clone the repository to.
